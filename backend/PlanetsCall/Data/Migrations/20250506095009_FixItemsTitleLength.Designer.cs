...
namespace Data.Migrations
{
    ...
    [Migration("20250506095009_FixItemsTitleLength")]
    partial class FixItemsTitleLength
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ItemsUsers1", b =>
                {
                    b.Property<int>("CurrentlySelectingId")
                        .HasColumnType("integer");

                    b.Property<int>("ItemsSelectedId")
                        .HasColumnType("integer");

                    b.HasKey("CurrentlySelectingId", "ItemsSelectedId");

                    b.HasIndex("ItemsSelectedId");

                    b.ToTable("SelectedItems", (string)null);
                });
            ...
            modelBuilder.Entity("Data.Models.OrganizationVerificationRequests", b =>
                {
                    b.HasOne("Data.Models.Organisations", "Organisation")
                        ...
                        .HasForeignKey("Data.Models.OrganizationVerificationRequests", "OrganisationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("ItemsUsers1", b =>
                {
                    b.HasOne("Data.Models.Users", null)
                        .WithMany()
                        .HasForeignKey("CurrentlySelectingId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Data.Models.Items", null)
                        .WithMany()
                        .HasForeignKey("ItemsSelectedId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
